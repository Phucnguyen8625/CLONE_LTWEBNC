    ...
    <main class="flex-1 flex flex-col">
        ...
        <header class="h-16 bg-white shadow flex items-center justify-between px-6">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-2xl font-semibold text-gray-800">Thêm Danh Mục Mới</h2>
            </div>
        </header>
        ...
        <div class="p-6 flex-1 overflow-y-auto w-full max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-md border-0 overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-medium text-gray-800">Thông tin phân loại truyện</h3>
                    <p class="text-sm text-gray-500 mt-1">Điền thông tin để phân loại thể loại cho các bộ truyện.</p>
                </div>
                
                <form action="admin.php?action=store" method="POST" class="p-6 space-y-6">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Tên Danh Mục <span class="text-red-500">*</span></label>
                        <input type="text" id="name" name="name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" placeholder="Ví dụ: Hành động, Tình cảm...">
                    </div>

                    <div>
                        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Mô tả chi tiết</label>
                        <textarea id="description" name="description" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" placeholder="Giới thiệu về thể loại này..."></textarea>
                    </div>

                    <div class="flex items-center">
                        <input type="checkbox" id="status" name="status" value="1" checked class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
