...
<aside class="w-64 bg-adminPrimary text-slate-300 flex-shrink-0 flex flex-col transition-all duration-300">
    ...
    <div class="p-4 bg-slate-950/30 border-t border-slate-800">
        <a href="index.php" target="_blank" class="flex items-center px-4 py-2 text-xs text-slate-400 hover:text-white transition-colors">
            <i class="fas fa-external-link-alt mr-3"></i> Xem website
        </a>
