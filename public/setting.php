...
$duongDanThuVien = [
    [
        'icon' => 'hard_drive',
        'ten' => 'Kho truyện chính',
        'duongDan' => 'C:/Users/Creative/Documents/KineticInk/Library/',
        'loai' => 'dung_luong',
        'nhan' => 'Dung lượng',
        'giaTri' => '428 GB / 600 GB',
        'phanTram' => 65,
    ],
    [
        'icon' => 'cloud',
        'ten' => 'Kho đồng bộ đám mây',
        'duongDan' => '/mnt/share/cloud_comics/ink_sync',
        'loai' => 'dong_bo',
        'nhan' => 'Trạng thái đồng bộ',
        'giaTri' => 'Đã đồng bộ',
    ],
];
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/public/settingStyle.css">
</head>
<body>
    <header class="topbar">
        ...
        <main class="main">
            ...
            <div class="content">
                <header class="page-header">
                    ...
                    <p>
                        Cấu hình bộ máy đọc truyện, quản lý kho lưu trữ truyện tranh cục bộ
                        và luôn cập nhật nền tảng Kinetic Ink với những tính năng biên tập mới nhất.
                    </p>
                </header>
    ...
    <script src="../assets/js/public/setting.js"></script>
</body>
</html>